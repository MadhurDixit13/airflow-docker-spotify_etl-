...
conn = BaseHook.get_connection("spotify_api") #creating a connection to the spotify_api
client_id = conn.login
client_secret = conn.password
redirect_uri = Variable.get("spotify_redirect_uri") # This is the redirect URI which we have set in the spotify API
auth_code = Variable.get("spotify_auth_code") # This is the auth code which we have obtained from the callback URL by running the server.py
EST = pytz.timezone("Canada/Eastern") 
my_db = 'my_db' # Enter the name of your DB which you have saved under connection in Airflow UI
